...
<button type="{{ $button_type }}" wire:loading.attr="disabled" wire:loading.class="animate-bounce"
    ...
    <div wire:loading wire:target="{{ $target }}" role="status">
        <span>Loading...</span>
        <svg aria-hidden="true" class="inline w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-green-500"
